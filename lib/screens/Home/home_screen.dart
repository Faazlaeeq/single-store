...
class _HomeScreenState extends State<HomeScreen> {
  ...
  PreferredSizeWidget appbar() {
    ...
    if (selectedPageIndex == 0) {
      ab = MyAppbar(scaffoldKey: scaffoldKey);
    } else {
      ab = MyAppbar(
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Text("Our Lussore Man",
              style: Theme.of(context).textTheme.titleLarge!.copyWith(
                  color: MyColors.subtitleColor, fontWeight: FontWeight.bold)),
          SizedBox(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage("assets/images/cat-clothes.png"))),
                  child: Container(
                      height: 50,
                      width: double.infinity,
                      decoration: BoxDecoration(
    ...
    return Scaffold(
      ...
      body: PageView(
          ...
          children: [homeScreen, MyOrderScreen(), ProfileScreen()]),
